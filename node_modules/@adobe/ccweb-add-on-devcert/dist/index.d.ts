...
export declare function location(): string;
export declare function removeDomain(requestedDomains: string | string[]): Promise<void>;
export declare function removeAll(): void;
export declare function caExpiryInDays(): number;
export declare function certificateExpiryInDays(domain: string): number;
export {};
